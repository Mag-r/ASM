...
N_particles_per_wall_per_dim = 25
fluid_density = 26.18
viscosity = 0.25
friction = 15.0
E_field = [25.0,0,0]
...
system.non_bonded_inter[0, 0].wca.set_params(epsilon=10000, sigma=1)
system.non_bonded_inter[0, 1].wca.set_params(epsilon=10000, sigma=1)
